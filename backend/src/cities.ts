...
export const GERMAN_CITIES = [
  ...
  'Halle (Saale)', 'Hamburg', 'Hameln', 'Hamm', 'Hanau', 'Hannover', 'Hattingen', 'Heidelberg', 'Heidenheim', 'Heilbronn', 'Herford',
  ...
  'Wolfenbüttel', 'Wolfratshausen', 'Wolfsburg', 'Worms', 'Wuppertal', 'Würzburg', 'Zwickau'
];
